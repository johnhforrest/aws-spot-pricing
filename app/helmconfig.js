...
const config = {
  ...
  meta: [
    ...
    { name: 'description', content: 'A tool that helps calculate the optimal cluster on Amazon EC2 given requirements' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Calculate optimal cluster on Amazon EC2' },
